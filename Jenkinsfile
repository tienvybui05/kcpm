                ...
                dir('backend/test') {
                    script {
                        ...
                        if (isTimer) {
                            ...
                            else if (commitMsg.contains('[transaction-service]')) {
                                echo '🚀 Bắt đầu test riêng lẻ: transaction-service'
                                sh 'node jira_automation.js "transaction-service"'
                            }
                            else if (commitMsg.contains('[battery-service]')) {
                                echo '🚀 Bắt đầu test riêng lẻ: battery-service'
                                sh 'node jira_automation.js "battery-service"'
                            }
